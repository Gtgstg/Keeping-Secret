...
router.get('/',checkLoginUser, function(req, res, next) {
    ...
    res.render('addNewCategory', { title: 'Keeping Secrets',loginUser: loginUser,errors:'',success:'' });
...
router.post('/',checkLoginUser, [ check('passwordCategory','Enter Password Category Name').isLength({ min: 1 })],function(req, res, next) {
        ...
        if(!errors.isEmpty()){
          ...
          res.render('addNewCategory', { title: 'Keeping Secrets',loginUser: loginUser, errors:errors.mapped(),success:'' });
           ...
           passcatDetails.save(function(err,doc){
             if(err) throw err;
             res.render('addNewCategory', { title: 'Keeping Secrets',loginUser: loginUser, errors:'', success:'Password category inserted successfully' });
