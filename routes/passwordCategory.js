...
router.get('/', checkLoginUser,function(req, res, next) {
    ...
    getPassCat.exec(function(err,data){
      if(err) throw err;
    res.render('password_category', { title: 'Keeping Secrets',loginUser: loginUser,records:data});
  });
  });
  ...
  router.get('/edit/:id', checkLoginUser,function(req, res, next) {
    ...
    getpassCategory.exec(function(err,data){
      ...
      res.render('edit_pass_category', { title: 'Keeping Secrets',loginUser: loginUser,errors:'',success:'',records:data,id:passcat_id});
