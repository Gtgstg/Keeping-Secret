...
router.get('/', checkLoginUser,function(req, res, next) {
  ...
  if(err) throw err;
  res.render('add-new-password', { title: 'Keeping Secrets',loginUser: loginUser,records: data,success:''});
  ...
  var password_details= new passModel({
    ...
    password_details.save(function(err,doc){
      getPassCat.exec(function(err,data){
        if(err) throw err;
      res.render('add-new-password', { title: 'Keeping Secrets',loginUser: loginUser,records: data,success:"Password Details Inserted Successfully"});
